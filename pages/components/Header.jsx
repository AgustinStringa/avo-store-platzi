        ...
        <header className="site-header container">
          <nav>
            <ul>
              <li>
                <Link href="/" legacyBehavior>
                  <a
                    href=""
                    className={`home-link 
                  ${router.pathname === "/" ? "home-link-active" : null}`}
                  >
              ...
              <li>
                <Link href="/cart" className="cart-link" legacyBehavior>
                  <a
                    href=""
                    className={`home-link 
                  ${router.pathname === "/cart" ? "home-link-active" : null}`}
                  >
